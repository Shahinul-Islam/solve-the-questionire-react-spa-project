...
const Blog = () => {
  return (
    <div className="p-4">
      <div className="my-4">
        <h2 className="py-2 font-bold">What is the purpose of react router?</h2>
        <p>
      ...
      <div>
        <h2 className="py-2 font-bold">How does context API works?</h2>
        <p>
      ...
      <div className="mt-4">
        <h2 className="py-2 font-bold">How will you describe useRef hook?</h2>
        <p>
